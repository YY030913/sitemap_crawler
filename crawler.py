...
class Crawler():
	...
	def run(self):
		...
		print >> self.output_file,config.xml_header
		...
		print >> self.output_file,config.xml_footer
	...
	def __crawling(self):
		...
		request = urllib2.Request(crawling, headers={"User-Agent":config.crawler_user_agent})#Request(crawling, headers={"User-Agent":config.crawler_user_agent})
